...
public class Logic 
    ...
    public static double rightTriangleArea(double base, double height){
        // To calculate the area of right angled triangle.
        double areaOfRightTriangle = (1/2) * base * height;
        return areaOfRightTriangle;
    }
    public static double rightTrianglePerimeter(double base, double height){
        // To calculate the volume of right angled triangle.
        double perimeterOfRightTriangle = base + height + Math.sqrt(Math.pow(base,2) + Math.pow(height,2));
        return perimeterOfRightTriangle;
    }
    public static double boxVolume(double length, double width, double depth){
        // Tp calculate the volume of box.
        double volumeOfBox = length * width * depth;
        return volumeOfBox;
    }
    public static double boxSurfaceArea(double length, double width, double depth){
        // To calculate the surface area of box.
        double surfaceAreaOfBox = (2 * length * width) + (2 * length * depth) + (2 * width * depth);
        return surfaceAreaOfBox;
    }
    ...
    public static double sphereSurfaceArea(double radius){
        ...
        double surfaceAreaOfSphere = 4 * Math.PI * Math.pow(radius,2);
